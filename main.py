...
def game():
    ...
    b_back = Button(size=(4 * 80, 2 * 80), position=(10 * 80, 1 * 80), base_color=(0, 0, 0), pointed_color=(32, 32, 32),
                    text='Назад')
    buttons.add(b_back)
    b_yes = Button(size=(4 * 80, 2 * 80), position=(10 * 80, 3.5 * 80), base_color=(64, 192, 64),
                   pointed_color=(96, 226, 96))
    buttons.add(b_yes)
    b_no = Button(size=(4 * 80, 2 * 80), position=(10 * 80, 6 * 80), base_color=(192, 64, 64),
                  pointed_color=(226, 96, 96))
    buttons.add(b_no)
...
def example():
    ...
    """Кнопки окна"""
    buttons = pygame.sprite.Group()
    b_game = Button(size=(4 * 80, 2 * 80), position=(2 * 80, 1 * 80), base_color=(0, 0, 0), pointed_color=(32, 32, 32),
                    text='НАЧАЛО ИГРЫ')
    buttons.add(b_game)
    b_authors = Button(size=(4 * 80, 2 * 80), position=(2 * 80, 3.5 * 80), base_color=(0, 0, 0),
                       pointed_color=(32, 32, 32), text='Авторы')
    buttons.add(b_authors)
    b_settings = Button(size=(4 * 80, 2 * 80), position=(2 * 80, 6 * 80), base_color=(0, 0, 0),
                        pointed_color=(32, 32, 32), text='Настройки')
    buttons.add(b_settings)
    board = Board(lines_and_columns=(9, 16), cell_size=(80, 80), grid_color=(32, 128, 32))
    b_exit = Button(size=(4 * 80, 2 * 80), position=(6 * 80, 3.5 * 80), base_color=(0, 0, 0),
                    pointed_color=(32, 32, 32), text='Вырубай')
    buttons.add(b_exit)
    # и тут создание кнопочек
    """Основной игровой цикл окна"""
    # запуск цикла
